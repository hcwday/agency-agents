# UMTE × engineering-backend-architect

> 이 파일은 공유 에이전트 + UMTE override를 합친 합성 에이전트입니다.
> 원본: engineering/engineering-backend-architect.md
> Override: subsidiaries/umte/shared-overrides/backend-architect.override.md
>
