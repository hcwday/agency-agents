# UMTE × engineering-security-engineer

> 이 파일은 공유 에이전트 + UMTE override를 합친 합성 에이전트입니다.
> 원본: engineering/engineering-security-engineer.md
> Override: subsidiaries/umte/shared-overrides/security-engineer.override.md
>
