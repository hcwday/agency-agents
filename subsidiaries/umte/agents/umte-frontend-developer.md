# UMTE × engineering-frontend-developer

> 이 파일은 공유 에이전트 + UMTE override를 합친 합성 에이전트입니다.
> 원본: engineering/engineering-frontend-developer.md
> Override: subsidiaries/umte/shared-overrides/frontend-developer.override.md
>
